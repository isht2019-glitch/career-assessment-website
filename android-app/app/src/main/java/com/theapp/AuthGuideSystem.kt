...
class AuthGuideSystem(private val context: Context, private val parentView: ViewGroup) {
    ...
    fun init() {
        ...
        // Start guide automatically and immediately for auth page
        handler.postDelayed({
            startGuide()
        }, 100)
    }
    ...
    private fun completeGuide() {
        ...
        prefs.edit()
            .putBoolean("auth_guide_completed", true)
