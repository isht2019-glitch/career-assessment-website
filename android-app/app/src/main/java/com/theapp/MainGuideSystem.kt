...
class MainGuideSystem(private val context: Context, private val parentView: ViewGroup) {
    ...
    fun init() {
        ...
        // Start guide automatically and immediately for main page
        handler.postDelayed({
            startGuide()
        }, 100)
    }
    ...
    private fun showWelcomeStep() {
        // Welcome text
        addTextView("Welcome to TheApp! 🎉", "#FF6B35", true)
        addTextView("I'm Velly Bandaar, your personal guide! 🐵", "#FFD700", true)
        addTextView("This app will help you discover your perfect career path through our comprehensive assessment. 🚀", "#FFFFFF")
        addTextView("Let's get started on your journey to success! ✨", "#FFFFFF")
        
        val startBtn = createButton("Let's begin!", "#4CAF50") {
            completeGuide()
        }
    ...
    private fun completeGuide() {
        ...
        prefs.edit()
            .putBoolean("main_guide_completed", true)
            .apply()
    }
